...
def chat():
    ...
    image = request.files.get("image")  # For future multimodal features
    ...
    # FIX: Defined chat_id before using it in conversation_memory
    chat_id = "default"
...
# RUN                          #
# ---------------------------- #
# FIX: Dynamically bind host and port for production environments
